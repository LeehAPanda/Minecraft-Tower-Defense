...
public class MouseInputs implements MouseListener, MouseMotionListener {
	...
	public void mouseDragged(MouseEvent e) {
		...
		case SETTINGS:
			...
			break;
		case CREATIVE:
			game.getCreative().mouseDragged(e.getX(), e.getY());
			break;
		default:
			break;
		}
	...
	public void mouseMoved(MouseEvent e) {
		...
		case SETTINGS:
			...
			break;
		case CREATIVE:
			game.getCreative().mouseMoved(e.getX(), e.getY());
			break;
		case GAMEOVER:
	...
	public void mouseClicked(MouseEvent e) {
		if (e.getButton() == MouseEvent.BUTTON1) {
			...
			case SETTINGS:
				...
				break;
			case CREATIVE:
				game.getCreative().mouseClicked(e.getX(), e.getY());
				break;
			case GAMEOVER:
	...
	public void mousePressed(MouseEvent e) {
		...
		case SETTINGS:
			...
			break;
		case CREATIVE:
			game.getCreative().mousePressed(e.getX(), e.getY());
			break;
		case GAMEOVER:
	...
	public void mouseReleased(MouseEvent e) {
		...
		case SETTINGS:
			...
			break;
		case CREATIVE:
			game.getCreative().mouseReleased(e.getX(), e.getY());
			break;
		case GAMEOVER:
